# Cap Taxi
###### Commissioned MVP | Full-cycle Development
...
**Tech Stack:** <br>
Kotlin, Jetpack Compose, Clean Architecture, MVVM, Coroutines, Flow, Google Maps, Retrofit, Google Cloud API (Directions API, Places API), Android Fused Location Provider, Compose Animations, Hilt, JUnit, Mockito, Gradle KTS.
